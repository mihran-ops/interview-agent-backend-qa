...
const kbPath = path.join(ROOT, 'src', 'routes', 'client', 'kb.js');
const dotenvPath = require.resolve('dotenv');

// Every router except routes/kb.js, which is replaced by one that throws on demand.
const ROUTE_STUBS = [
  'src/routes/client/dashboardRouter.js', 'src/routes/client/roles.js', 'src/routes/automation/index.js', 'src/routes/webhooks/stripe.js',
  'src/routes/webhooks/sendgrid.js', 'src/routes/webhooks/telnyx.js', 'src/routes/webhooks/tavus.js',
  'src/routes/public/candidateSubmit.js', 'src/routes/public/verifyOtp.js', 'src/routes/public/createTavusInterview.js',
  'src/routes/public/accommodationRequests.js', 'src/routes/public/textInterview.js', 'src/routes/client/members.js',
  'src/routes/client/feedback.js', 'src/routes/public/alphascreen/index.js', 'src/routes/public/analytics.js',
  'src/routes/public/leads.js', 'src/routes/admin/billingRouter.js', 'src/routes/public/tavus.js',
  'src/routes/public/interviewStatus.js', 'src/routes/public/membershipAgreements/index.js', 'src/routes/client/rolesUpload.js',
  'src/routes/client/files.js', 'src/routes/client/reports.js', 'src/routes/client/reportsPdf.js',
];
